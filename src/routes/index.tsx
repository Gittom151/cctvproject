    ...
    <div className="relative group aspect-video bg-neutral-900 border border-neutral-800 rounded-lg overflow-hidden flex flex-center items-center justify-center transition-all hover:border-blue-500/50">
      {videoSrc ? (
        ...
        >
          ...
          <span className="text-sm font-medium">Upload CCTV Feed {id}</span>
        </div>
      )}
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-neutral-200 font-sans selection:bg-blue-500/30">
      ...
      <header className="h-16 border-b border-neutral-800 flex items-center justify-between px-6 bg-black/50 backdrop-blur-xl sticky top-0 z-50">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-bold tracking-tight text-white uppercase">EagleEye Sentinel</h1>
            <p className="text-[10px] text-neutral-500 font-medium">AI MONITORING SYSTEM V2.4</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2 px-3 py-1.5 bg-neutral-900 rounded-md border border-neutral-800">
            ...
            <span className="text-xs font-mono text-neutral-400">SYS_OK: 98.4%</span>
          </div>
          <div className="text-right">
            <div className="text-xs font-mono text-neutral-400 tracking-widest">{currentTime}</div>
            <div className="text-[10px] text-neutral-600 font-bold uppercase tracking-tighter">System Live</div>
          </div>
        </div>
      </header>
        ...
        <div className="flex-1 p-6 overflow-y-auto">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-semibold uppercase tracking-widest text-neutral-400">Grid View: 2x2</h2>
            </div>
            <div className="flex gap-2">
               <button className="px-3 py-1.5 bg-neutral-900 hover:bg-neutral-800 border border-neutral-800 rounded text-xs transition-colors">REC ALL</button>
               <button className="px-3 py-1.5 bg-neutral-900 hover:bg-neutral-800 border border-neutral-800 rounded text-xs transition-colors">PTZ CONTROL</button>
            </div>
          </div>
        ...
        <aside className="w-80 border-l border-neutral-800 bg-neutral-900/30 flex flex-col">
          <div className="p-4 border-b border-neutral-800">
            <h2 className="text-xs font-bold uppercase tracking-widest text-neutral-500 flex items-center gap-2">
              <Activity className="w-3 h-3" /> Incident Log
            </h2>
          </div>
          ...
          <div className="flex-1 p-4 flex flex-col gap-4 overflow-y-auto">
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-neutral-600 p-8 text-center">
              ...
              <p className="text-xs uppercase tracking-tighter font-semibold opacity-40">No Incidents Detected</p>
              <p className="text-[10px] mt-1 leading-relaxed opacity-30">Monitoring live feeds for anomalies, collisions, and security breaches.</p>
            </div>

            {/* Placeholder Analytics Card */}
            <div className="p-4 rounded-xl bg-neutral-900 border border-neutral-800/50">
              <h3 className="text-[10px] font-bold text-neutral-500 uppercase mb-3">Traffic Density</h3>
            ...
            <div className="p-4 rounded-xl bg-neutral-900 border border-neutral-800/50">
              <div className="flex items-center gap-2 text-amber-500/50 mb-3">
                ...
                <h3 className="text-[10px] font-bold uppercase">System Alerts</h3>
              </div>
